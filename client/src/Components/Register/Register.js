...
function Register() {
    ...
    const handleErrors = (errors) => {
        ...
        if(errors.name === "" && errors.email === "" && errors.password === "") return true
        return false
    } 
    ...
    <div className='d-flex justify-content-center align-items-center bg-primary-subtle vh-100'>
        <div className='bg-white p-3 rounded w-25'> 
            ...
            <form action='' onSubmit={handleSubmit}>
                ...
                <Link to="/" className='btn btn-default border w-100 bg-light rounded-0 text-decoration-none'>Have an account?</Link>
            </form>
        </div>
    </div>
  )
